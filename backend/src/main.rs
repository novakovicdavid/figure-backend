...
use entities::figure::repository::FigureRepository;
...
use entities::figure::service::FigureService;
use entities::profile::service::ProfileService;
use entities::user::service::UserService;
use crate::entities::figure::routes::{browse_figures, browse_figures_from_profile, browse_figures_from_profile_starting_from_figure_id, browse_figures_starting_from_figure_id, get_figure, get_total_figures_by_profile, get_total_figures_count, landing_page_figures, upload_figure};
